...
namespace FluentTerminal.App.Services
{
    public class Terminal
    {
        ...
        public async Task<CreateTerminalResponse> StartShellProcess(ShellProfile shellProfile, TerminalSize size, SessionType sessionType, string termState)
        {
            ...
            {
                var response = await _trayProcessCommunicationService.PauseTerminalOutput(Id, false);
